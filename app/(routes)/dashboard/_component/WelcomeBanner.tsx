...
function WelcomeBanner() {
  return (
    <div className='p-5 bg-gradient-to-r from-[#BE575F] via [#A338E3] to-[#AC7626] rounded-xl'>
      ...
      <Button variant={'outline'} className='mt-5 rounded-xl'>Let's Get Started</Button>
